...
setwd("~/Dropbox/Database/Campaign/")
runForAll <- function(x) {
  campaignName<- x #Do not put extention. File should be saves in .xlsx format ONLY.
  ...
  fileC<-read_excel(paste0(dirCampaign, campaignName, sep=""))  #reads the Campaign file
  #load the test data--------------------------------------------------------------------------------------------
